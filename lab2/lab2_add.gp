...
plot \
     "< grep add-none lab2_add-1.csv | grep ',0$'" using ($2):($3) \
	title 'w/o yields' with points lc rgb 'green', \
     "< grep add-yield-none lab2_add-1.csv | grep ',0$'" using ($2):($3) \
...
plot \
     "< grep 'add-none,8,' lab2_add-2.csv" using ($3):($6) \
		title 'Threads=8, w/o yields' with points lc rgb 'green', \
     "< grep 'add-yield-none,8,' lab2_add-2.csv" using ($3):($6) \
		title 'Threads=8, w/yields' with points lc rgb 'red', \
     "< grep 'add-none,32,' lab2_add-2.csv" using ($3):($6) \
		title 'Threads=32, w/o yields' with points lc rgb 'green', \
     "< grep 'add-yield-none,32,' lab2_add-2.csv" using ($3):($6) \
		title 'Threads=32, w/yields' with points lc rgb 'red'
...
plot "< grep 'add-none,1,' lab2_add-3.csv" using ($3):($6) \
...
plot \
     "< grep add-yield-none lab2_add-4.csv | grep ',0$'" using ($2):($3) \
	title 'unprotected w/yields' with points lc rgb 'red', \
     "< grep add-yield-c lab2_add-4.csv | grep ',0$'" using ($2):($3) \
	title 'CAS w/yields' with points lc rgb 'green', \
     "< grep add-yield-m lab2_add-4.csv | grep ',0$'" using ($2):($3) \
	title 'mutex w/yields' with points lc rgb 'blue', \
     "< grep add-yield-s lab2_add-4.csv | grep ',0$'" using ($2):($3) \
...
# grep out only successful (sum=0) yield runs
plot \
     "< grep 'add-none,1,100000,' lab2_add-5.csv" using ($2):($6) \
	title 'unprotected' with linespoints lc rgb 'red', \
     "< grep -e 'add-c,[0-9]*,100000,' lab2_add-5.csv" using ($2):($6) \
	title 'CAS' with linespoints lc rgb 'green', \
     "< grep -e 'add-m,[0-9]*,100000,' lab2_add-5.csv" using ($2):($6) \
	title 'mutex' with linespoints lc rgb 'blue', \
     "< grep -e 'add-s,[0-9]*,100000,' lab2_add-5.csv" using ($2):($6) \
