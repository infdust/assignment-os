...
plot \
     "< grep 'list-none-none,1,' lab2_list-1.csv" using ($3):($7) \
	title 'raw' with linespoints lc rgb 'red', \
     "< grep 'list-none-none,1,' lab2_list-1.csv" using ($3):($7)/(4*($3)) \
...
plot \
     "< grep list-none-none lab2_list-2.csv" using ($2):($3) \
	title 'w/o yields' with points lc rgb 'green', \
     "< grep list-i-none lab2_list-2.csv" using ($2):($3) \
	title 'yield=i' with points lc rgb 'red', \
     "< grep list-d-none lab2_list-2.csv" using ($2):($3) \
	title 'yield=d' with points lc rgb 'violet', \
     "< grep list-il-none lab2_list-2.csv" using ($2):($3) \
...
plot \
    "< grep 'list-i-none,24,' lab2_list-3.csv" using (1):($3) \
	with points lc rgb "red" title "unprotected, T=12", \
    "< grep 'list-d-none,24,' lab2_list-3.csv" using (2):($3) \
	with points lc rgb "red" title "", \
    "< grep 'list-il-none,24,' lab2_list-3.csv" using (3):($3) \
	with points lc rgb "red" title "", \
    "< grep 'list-dl-none,24,' lab2_list-3.csv" using (4):($3) \
	with points lc rgb "red" title "", \
    "< grep 'list-i-m,24,' lab2_list-3.csv" using (1):($3) \
	with points lc rgb "green" title "Mutex, T=12", \
    "< grep 'list-d-m,24,' lab2_list-3.csv" using (2):($3) \
	with points lc rgb "green" title "", \
    "< grep 'list-il-m,24,' lab2_list-3.csv" using (3):($3) \
	with points lc rgb "green" title "", \
    "< grep 'list-dl-m,24,' lab2_list-3.csv" using (4):($3) \
	with points lc rgb "green" title "", \
    "< grep 'list-i-s,24,' lab2_list-3.csv" using (1):($3) \
	with points lc rgb "blue" title "Spin-Lock, T=12", \
    "< grep 'list-d-s,24,' lab2_list-3.csv" using (2):($3) \
	with points lc rgb "blue" title "", \
    "< grep 'list-il-s,24,' lab2_list-3.csv" using (3):($3) \
	with points lc rgb "blue" title "", \
    "< grep 'list-dl-s,24,' lab2_list-3.csv" using (4):($3) \
	with points lc rgb "blue" title ""
#
...
set key left top
plot \
     "< grep -e 'list-none-m,[0-9]*,1000,' lab2_list-4.csv" using ($2):($7)/(($3)/4) \
	title '(adjusted) list w/mutex' with linespoints lc rgb 'blue', \
     "< grep -e 'list-none-s,[0-9]*,1000,' lab2_list-4.csv" using ($2):($7)/(($3)/4) \
